# Домашнее задание к занятию 11.1. «Базы данных, их типы» - "Червяков Антон"
...
```
Возможно в обоих случаях уместно использовать Объектно-ориентированную СУБД
```
...
```
Возможно, в данном случае можно использовать Графовую СУБД
```
